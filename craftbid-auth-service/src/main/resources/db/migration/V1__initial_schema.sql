...
CREATE TABLE IF NOT EXISTS auctions (
    ...
    first_deposit_paid_at DATETIME(6) DEFAULT NULL,
    participation_deadline DATETIME(6) DEFAULT NULL,
    prep_deadline DATETIME(6) DEFAULT NULL,
    initial_wait_deadline DATETIME(6) DEFAULT NULL,
    turn_deadline DATETIME(6) DEFAULT NULL,
    admin_fee_amount DECIMAL(12, 2) DEFAULT NULL,
    artisan_payout_amount DECIMAL(12, 2) DEFAULT NULL,
    created_at DATETIME(6) NOT NULL,
...
CREATE TABLE IF NOT EXISTS auction_participants (
    ...
    cancellation_refund_amount DECIMAL(12, 2) DEFAULT 0.00,
